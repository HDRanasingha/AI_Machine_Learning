...
for userIdx = 1:numUsers
    ...
    fileName = sprintf('U%02d_Acc_FreqD_FDay.mat', userIdx);
    dataFirstDay = load(fileName);
    ...
    if isfield(dataFirstDay, 'Acc_FD_Feat_Vec')
        userData = dataFirstDay.Acc_FD_Feat_Vec; 
    else
