...
for userIdx = 1:numUsers
    ...
    fileName = sprintf('U%02d_Acc_TimeD_FreqD_FDay.mat', userIdx);
    datacombineFDay = load(fileName);
    ...
    if isfield(datacombineFDay, 'Acc_TDFD_Feat_Vec')
        userData = datacombineFDay.Acc_TDFD_Feat_Vec; 
    else
