...
numofUsers = 10; % Total number of users
numofFilesPerUser = 6; % Files per user
...
if ~isempty(Acc_TimeD_FDay)
    ...
    disp(['Test Performance for Acc_TimeD_FDay: ', num2str(testPerformance)]);
    ...
    disp(['Test Accuracy for Acc_TimeD_FDay: ', num2str(accuracyPercentage), '%']);
