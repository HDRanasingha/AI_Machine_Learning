...
FrequncyFile = 'Frequncy.mat';

% Check if the file exists
if isfile(FrequncyFile)
    % Load previous accuracy data
    load(FrequncyFile, 'Frequncy');
else
...
if ~isempty(Acc_FreqD_FDay)
    ...
    Frequncy = [Frequncy; accuracyPercentage];
    save(FrequncyFile, 'Frequncy');
    ...
    figure;
    plot(Frequncy, '-o', 'LineWidth', 2, 'MarkerSize', 6);
    xlabel('Run Number');
    ylabel('Accuracy (%)');
